...
export const NAV_MAIN: NavItem[] = [
  ...
  { href: '/professores', label: 'Professores', icon: 'professores', permission: 'teacher.view', soon: 'E2' },
...
export const NAV_ADMIN: NavItem[] = [
  { href: '/admin/cadastros', label: 'Cadastros', icon: 'cadastros', permission: 'admin.catalog', soon: 'E2' },
